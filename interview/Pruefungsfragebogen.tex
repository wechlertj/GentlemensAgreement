...
%
\newcommand{\janein}[2]{
    \frame{\CheckBox[name=#1,backgroundcolor={.85 .85 .85},bordercolor={black}]{Ja}}\hspace{0.8cm}
    \CheckBox[name=#2,backgroundcolor={.85 .85 .85},bordercolor={black}]{Nein}
}
...
\frage{Was ist deine Meinung zu dem Spruch ``Man lernt nie aus``?}\par
\textarea{lernen}{4}

\frage{Was ist deine Meinung zu dem Spruch ``lebe als wäre es dein letzer Tag, lerne als ob du ewig leben würdest``?}\par
...
\frage{``Das Leben, als ganzes ist ein Spiel der unendlichkeit``. Was denkst du über diese Aussage?}\par
...
\frage{An was denkst du wenn du das Wort Lady hörst?}\par
\textarea{lady}{4}

\frage{An was denkst du wenn du das Wort ``Gentleman`` hörst?}\par
\textarea{Gentleman}{4}
